...
btn_piedra.onclick = function() {
    Opcion_jugador = 0;
    img_usuario.src = "Piedra.png";
}
btn_papel.onclick = function() {
    Opcion_jugador = 1;
    img_usuario.src = "Papel.png";
}
btn_tijeras.onclick = function() {
    Opcion_jugador = 2;
    img_usuario.src = "Tijeras.png";
}
...
function init_imagenes() {
    btn_piedra.style.backgroundImage = " url('Piedra.png')";
    btn_papel.style.backgroundImage = " url('Papel.png')";
    btn_tijeras.style.backgroundImage = "url('Tijeras.png')";
}
...
function display_opcion_cpu(opcion) {
    if (opcion === 0) {
        img_cpu.src = "Piedra.png";
    } else if (opcion === 1) {
        img_cpu.src = "Papel.png";
    } else {
        img_cpu.src = "Tijeras.png";
    }
}